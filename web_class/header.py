...
class HeaderArea:
    ...
    def work_space_displayed(self):
        try:
            ...
            if work_space_menu.is_displayed():
                print("워크스페이스 메뉴가 존재합니다.")
            else:
                None
            return work_space_menu.is_displayed
    ...
    def dis_on_off_displayed(self):
        try:
            ...
            if display_on_off.is_displayed():
                print("영상 on/off 메뉴가 존재합니다.")
            else:
                None
            return display_on_off.is_displayed
        except NoSuchElementException:
    ...
    def mic_on_off_displayed(self):
        try:
            ...
            if mic_on_off.is_displayed():
                print("마이크 on/off 메뉴가 존재합니다.")
            else:
                None
            return mic_on_off.is_displayed
        except NoSuchElementException:
            print("마이크 on/off 메뉴를 찾을 수 없습니다.")
            return False
    ...
    def speaker_menu_displayed(self):
        try:
            ...
            if speaker_menu.is_displayed():
                ...
                None
            return speaker_menu.is_displayed
        except NoSuchElementException:
            print("스피커 on/off 메뉴를 찾을 수 없습니다.")
            return False
    ...
    def notification_menu_displayed(self):
        try:
            ...
            if noti_menu.is_displayed():
                ...
                None
            return noti_menu.is_displayed
        except NoSuchElementException:
            print("알림 메뉴를 찾을 수 없습니다.")
            return False
    ...
    def noti_menu_optionbox(self):
        try:
            ...
            if noti_optionbox.is_displayed():
                print("알림 메뉴 옵션 박스 메뉴가 출력되었습니다..")
            else:
                None
            return noti_optionbox.is_displayed
        except NoSuchElementException:
            print("알림 메뉴 옵션 박스 메뉴를 찾을 수 없습니다.")
            return False
    ...
    def my_profile_menu_displayed(self):
        try:
            ...
            if my_profile.is_displayed():
                print("나의 프로필 메뉴가 존재합니다.")
            else:
                None
            return my_profile.is_displayed
        except NoSuchElementException:
            print("나의 프로필 메뉴를 찾을 수 없습니다.")
            return False
    ...
    def my_profile_list_displayed(self):
        try:
            ...
            if my_profile_dropdown.is_displayed():
    ...
    def work_station_menu_displayed(self):
        try:
            ...
            if work_station.is_displayed():
                print("나의 프로필 메뉴에 워크스테이션 메뉴가 존재합니다.")
            else:
                None
            return work_station.is_displayed
        except NoSuchElementException:
            print("나의 프로필 메뉴에서 워크스테이션 메뉴를 찾을 수 없습니다. ")
            return False
    ...
    def dash_board_menu_displyed(self):
        try:
            ...
            if dash_board.is_displayed():
                print("나의 프로필 메뉴에 대시보드 메뉴가 존재합니다.")
            else:
                None
            return dash_board.is_displayed
        except NoSuchElementException:
            print("나의 프로필 메뉴에서 대시보드 메뉴를 찾을 수 없습니다.")
            return False
    ...
    def local_file_menu_displayed(self):
        try:
            ...
            if local_file.is_displayed():
                print("나의 프로필 메뉴에 로컬파일 메뉴가 존재합니다.")
            else:
                None
            return local_file.is_displayed
        except NoSuchElementException:
            print("나의 프로필 메뉴에서 로컬파일 메뉴를 찾을 수 없습니다.")
            return False
    ...
    def logout_menu_displayed(self):
        try:
            ...
            print("나의 프로필 메뉴에서 로그아웃 메뉴를 찾을 수 없습니다.")
            return False
